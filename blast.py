...
parser = argparse.ArgumentParser(description = 'General purpose BLAST function.', usage = 'blast.py [options]')
...
parser.add_argument('-r', '--reward', type = int, help = 'Reward for nucleotide match. Optional.')
parser.add_argument('-p', '--penalty', type = int, help = 'Penalty for nucleotide mismatch. Optional.')
